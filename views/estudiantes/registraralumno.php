...
<div class="grid-container">
    <div class="grid-x text-center">
        ...
        <form action="<?php echo constant('URL') ?>estudiantes/RegistrarEstudiantes" method="GET" enctype="multipart/form-data">
            ...
            <div class="grid-x grid-padding-x">
                <div class="large-6 cell">
                    <label for="codigo">Código del Estudiante
                        <input type="text" name="codigo" id="codigo" placeholder="Ingrese el código del estudiante" required>
                    </label>
                </div>
                <div class="large-6 cell">
                    <label for="fechaNacimiento">Fecha de Nacimiento
                        <input type="date" name="fecNacimiento" id="fecNacimiento" required>
                    </label>
                </div>
            </div>
            <div class="grid-x grid-padding-x">
