    ...
    <div class="grid-x text-center">
        <div class="cell">
            ...
            <form action="<?php echo constant('URL'); ?>maestros/insertarDetalle" method="POST">
                ...
                <input type="number" id="idmaestro_detalle" name="idmaestro_detalle" required min="1" placeholder="Ingrese el ID del detalle">
                ...
                <textarea id="acercade" name="acercade" rows="4" required placeholder="Ingrese información adicional del maestro"></textarea>

                <button type="submit" class="button success" style="margin-top: 10px;">Guardar</button>
            </form>
        </div>
    </div>
</div>
